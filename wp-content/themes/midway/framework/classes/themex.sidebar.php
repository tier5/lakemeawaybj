...
class ThemexSidebar {
	...
	public static function renderSettings() {
		...
		$out=ThemexInterface::renderOption(array(
			...
			'type' => 'text',
			'after' => '<a href="#" class="themex-button themex-add-button button" data-action="themex_sidebar_add" data-value="themex_sidebar_name" data-container="themex_sidebar_items">'.__('Add Sidebar','midway').'</a>',				
			'attributes' => array(
				'placeholder' => __('Name','midway'),
			),
		));
	...
	public static function renderSidebar($sidebar) {
		...
		$out.='<a href="#" class="themex-button themex-remove-button themex-trigger" title="'.__('Remove', 'midway').'" data-action="themex_sidebar_remove" data-element="'.$sidebar['id'].'"></a>';
